...
//
//public class OriginalGolfUI {
//	Database database;
//	Scanner in;
//	
//	public OriginalGolfUI() {
...
//				}
//				if(tempAddQty > 1) {
//					System.out.println(tempAddQty + " " + "[" + tempAddGrade + "] " + tempAddBrand + " " + tempAddModel + " (" + tempAddColor + ") have been added to the inventory");
//				}
//				else {
//					System.out.println(tempAddQty + " " + "[" + tempAddGrade + "] " + tempAddBrand + " " + tempAddModel + " (" + tempAddColor + ") has been added to the inventory");
//				}
//		}
...
//		}
//		if(tempRemoveQty > 1) {
//			System.out.println(tempRemoveQty + " " + "[" + tempRemoveGrade + "] " + tempRemoveBrand + " " + tempRemoveModel + " (" + tempRemoveColor + ") have been removed from the inventory");
//		}
//		else {
//			System.out.println(tempRemoveQty + " " + "[" + tempRemoveGrade + "] " + tempRemoveBrand + " " + tempRemoveModel + " (" + tempRemoveColor + ") has been removed from the inventory");
//		}
//		System.out.println();
//		promptAction();
//	}
